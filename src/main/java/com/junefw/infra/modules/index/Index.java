...
public class Index {
	...
	public Date getRegDateTimed() {
		return regDateTimed;
	}
	public void setRegDateTimed(Date regDateTimed) {
		this.regDateTimed = regDateTimed;
	}
	...
	public void setIfjqQuestionName(String ifjqQuestionName) {
		this.ifjqQuestionName = ifjqQuestionName;
	}
